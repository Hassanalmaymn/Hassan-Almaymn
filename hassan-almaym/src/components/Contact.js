  ...
  return (
    <section id="contact" className="py-12 sm:py-16 md:py-20">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl sm:text-3xl font-bold text-center text-gray-800 mb-8 sm:mb-12">Contact Me</h2>
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/2 p-6 sm:p-8 bg-blue-600 text-white">
              ...
              <p className="mb-4 sm:mb-6 text-sm sm:text-base">Feel free to reach out to me for any inquiries or opportunities.</p>
